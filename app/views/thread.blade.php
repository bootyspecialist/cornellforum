		...
		<div id="reply-area">
			...
			@else
				<div id="new-comment-form">
					...
					<div class="form-group">
						<p class="need-to-login"><a class="btn btn-primary" href="/login"><i class="fa fa-sign-in"></i> Login</a> <a class="no-account-yet" href="/create-account">Don't have an account yet?</a></p>
					</div>
				</div>
			@endif
		</div>
