...
<html lang="en">
	<head>
    	...
    	{{ HTML::style('http://fonts.googleapis.com/css?family=Playfair+Display|Open+Sans') }}
	...
	<body>
			...
			<div class="navbar navbar-inverse navbar-static-top" role="navigation">
				<div class="container">
					<div class="navbar-header" title="is not endorsed in any way by Cornell University">
						<a class="navbar-brand" href="/"><img id="shh" src="/static/img/shh.png" height="55"/><span class="brand-text">Cornell Forum</span></a>
					</div>
		...
		<div id="footer">
			<div class="container">
				<div class="col-md-12">
					<p><i class="fa fa-copyright"></i> Cornell Forum is free, <a target="_blank" href="https://github.com/wnajar/cornellforum">open source</a>, student run and <strong>not</strong> endorsed in any way by Cornell University.</p>
				</div>
			</div>
		</div>
