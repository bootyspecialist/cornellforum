				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						@if (Auth::guest())
							...
							<li><a href="/users/create"><i class="fa fa-user"></i> Create Account</a></li>
						@else
					...
					<ul class="nav navbar-nav navbar-right">
						...
						@if (Auth::check())
							<li class="logged-in"><a href="/users/profile"><i class="fa fa-check"></i> <i class="fa fa-user"></i></a></li>
							<li><a title="log out" href="/users/logout"><i class="fa fa-sign-out"></i></a></li>
						@endif
					</ul>
				</div>
			</div>
